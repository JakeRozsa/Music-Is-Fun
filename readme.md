...
## Requirements
 - Visualization: 
    - xxx All songs are rendered when search button is clicked
    - XXX Bootstrap is utilized to provide styling to the page
    - XXX Each property of the song object is displayed (title, artist, price, album art, preview (hint: "html audio tag"))
  - Functionality: 
    - XXX A new search will clear out old results
...
### BONUS CHALLENGES 
- XXX Clicking on the title should play the 30 second preview 
- XXX The preview must play without opening a new browser window 
- Clicking play on a title while another song is already playing will stop the previous song and start the new one
- XXX When you search you will also get movies, try to filter those out
